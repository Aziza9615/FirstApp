...
import com.example.firstapp.ui.Contacts.helper.adapter.cat.getLikeImage

class PetsAdapter(private val listener: OnItemClick) : RecyclerView.Adapter<FavoritesViewHolder>() {

    private var array = mutableListOf<Pet>()
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FavoritesViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_favorite_pets, parent, false)
